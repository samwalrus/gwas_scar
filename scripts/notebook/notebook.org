...
/mnt/storage/private/alspacdata/freeze/original/gi_hrc_g0m_g1/data/plink
...
['scar_$(CHR).log.txt','scar$(CHR).assoc.txt'] <--['pheno.csv','covar.csv', geno_$(CHR).txt],
'./gemma 
\-p pheno.csv -c covar.csv -a map.txt -g geno_$(CHR).txt -notsnp -lm 2 -outdir . -o scar_$(CHR).

[gemma_basic_$(CHR)] <--['scar_$(CHR).log.txt','scar_$(CHR).assoc.txt'].
#+END_SRC
