...
#+RESULTS:
: gwscan_pheno2 <- read.table("./output/scar_lmm_bim_bam_chr11_pheno2.assoc.txt", as.is = "rs",header = TRUE)
: Processing SNPs                                             :  (275385/?,1971.8s,139.7/s)Processing SNPs                                             :  (275523/?,1972.9s,139.7/s)Processing SNPs                                             :  (275661/?,1973.9s,139.7/s)Processing SNPs                                             :  (275801/?,1974.9s,139.7/s)> Processing SNPs                                             :  (275941/?,1976.0s,139.6/s)i <- which.min(gwscan_pheno2$p_wald)
: gwscan_pheno2[i,]
:        chr       rs ps n_miss allele1 allele0    af       beta        se
...
#+RESULTS:
: gwscan_pheno3 <- read.table("./output/scar_lmm_bim_bam_chr11_pheno3.assoc.txt", as.is = "rs",header = TRUE)
: Processing SNPs                                             :  (277054/?,1984.3s,139.6/s)Processing SNPs                                             :  (277196/?,1985.4s,139.6/s)Processing SNPs                                             :  (277340/?,1986.4s,139.6/s)Processing SNPs                                             :  (277482/?,1987.4s,139.6/s)> i <- which.min(gwscan_pheno3$p_wald)
: gwscan_pheno3[i,]
:        chr       rs ps n_miss allele1 allele0    af       beta        se
